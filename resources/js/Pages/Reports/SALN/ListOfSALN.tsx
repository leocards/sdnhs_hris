...
const ListOfSALN = ({ saln, principal, hr, saln_years }: Props) => {
    ...
    useEffect(() => {
        ...
        if (!filter) {
            setFilter(saln_years.length > 0 ? saln_years[0].toString() : "");
        }
    }, [saln]);
                            ...
                            salnList.map((list, index) => (
                                ...
                                >
                                    <div className="grid grid-cols-[3rem,1fr,repeat(3,10rem),20rem,10rem,8rem] [&>div]:text-center [&>div]:py-3">
                                        ...
                                        >{`${list.user.last_name.toUpperCase()}, ${list.user.first_name.toUpperCase()} ${
                                            list.user.middle_name?.toUpperCase() ||
                                            ""
                                        }`}</div>
                                        ...
                                        <div className="">
                                            &#8369;{" "}
                                            {Number(
                                                toNumber(list.networth)
                                            ).toLocaleString()}
                                        </div>
                                        <div className="">{list.spouse}</div>
                                        <div className="">
                                            {list.joint && list.joint == 1
                                                ? "/"
                                                : ""}
                                        </div>
